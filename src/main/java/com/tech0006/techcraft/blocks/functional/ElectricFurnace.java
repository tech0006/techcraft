...
public class ElectricFurnace extends FacedBlock {
    ...
    private void dismantleBlock(World worldIn, BlockPos pos) {
        ...
        ElectricFurnaceTileEntity localTileEntity = (ElectricFurnaceTileEntity) worldIn.getBlockEntity(pos);
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new ElectricFurnaceTileEntity(TCTileEntityTypes.ELECTRIC_FURNACE.get());
    }
