...
import com.tech0006.techcraft.blocks.tileentity.functional.CoalGeneratorTileEntity;
...
public class CoalGenerator extends FacedBlock {
    ...
    private void dismantleBlock(World worldIn, BlockPos pos) {
        ...
        CoalGeneratorTileEntity localTileEntity = (CoalGeneratorTileEntity) worldIn.getBlockEntity(pos);
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new CoalGeneratorTileEntity(TCTileEntityTypes.COAL_GENERATOR.get());
    }
