...
public class ElectricCrusherTileEntity extends PoweredTile implements INamedContainerProvider {
    ...
    public ElectricCrusherTileEntity() {
        super(TCTileEntityTypes.ELECTRIC_CRUSHER.get(), 2);
        inventory = new TCItemHandler(4);
    }
    ...
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        assert level != null;
        return new ElectricCrusherContainer(TCContainerTypes.ELECTRIC_CRUSHER.get(), id, level, worldPosition, playerEntity, this);
    }

    @Override
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("container."+ techcraft.MOD_ID+".electric_crusher");
    }
    ...
    public ElectricCrusherRecipe getRecipe() {
        Set<IRecipe<?>> recipes = findRecipesByType(TCRecipeSerializerInit.ELECTRIC_CRUSHER_TYPE, this.level);
