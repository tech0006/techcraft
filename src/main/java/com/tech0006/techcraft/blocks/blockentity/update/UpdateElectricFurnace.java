...
public class UpdateElectricFurnace {
    ...
    public UpdateElectricFurnace(FriendlyByteBuf buf) {
    ...
    public UpdateElectricFurnace(BlockPos pos, InEnergy en, int enUse, int currT, int sumT) {
        this.pos = pos;
    ...
    public void handle(Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() ->
        {
            ...
            if (world.isLoaded(pos)) {
                ...
                if (te instanceof ElectricFurnaceBlockEntity) {
                    ElectricFurnaceBlockEntity gen = (ElectricFurnaceBlockEntity) te;
