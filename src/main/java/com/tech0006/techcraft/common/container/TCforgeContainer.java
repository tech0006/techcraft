...
public class TCforgeContainer extends AbstractContainerMenu {

    public TCforgeBlockEntity blockEntity;
    private Player playerEntity;
    private IItemHandler playerInventory;

    public TCforgeContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(TCContainerTypes.TC_FORGE.get(), windowId);
        blockEntity = (TCforgeBlockEntity) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, TCBlocks.TC_FORGE.get());
    }
