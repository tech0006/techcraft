...
import com.tech0006.techcraft.blocks.tileentity.functional.ElectricFurnaceTileEntity;
...
public class ElectricFurnaceContainer extends Container {
    ...
    public ElectricFurnaceContainer(ContainerType<?> type, int windowId, World world, BlockPos pos, PlayerEntity player) {
        super(type, windowId);
        this.tile = (ElectricFurnaceTileEntity) world.getBlockEntity(pos);
        this.player = player;
    ...
    public ElectricFurnaceContainer(ContainerType<?> type, int windowId, World world, BlockPos pos, PlayerEntity player, ElectricFurnaceTileEntity tileentity) {
        super(type, windowId);
        this.tile = (ElectricFurnaceTileEntity) Objects.requireNonNull(Objects.requireNonNull(world.getServer()).getLevel(World.OVERWORLD)).getBlockEntity(pos);
        this.player = player;
