...
public class ElectricCrusherRecipe implements IElectricCrusherRecipe {
    ...
    public static class ElectricCrusherRecipeSerializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<ElectricCrusherRecipe> {
        ...
        public ElectricCrusherRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            Ingredient input = ElectricCrusherRecipe.deserializeIn(GsonHelper.getAsJsonObject(json, "input"));
            ItemStack itemstack = ElectricCrusherRecipe.deserializeItem(GsonHelper.getAsJsonObject(json, "result"));
            return new ElectricCrusherRecipe(input, itemstack, recipeId, s);
        }

        public ElectricCrusherRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
        ...
        public void toNetwork(FriendlyByteBuf buffer, ElectricCrusherRecipe recipe) {
