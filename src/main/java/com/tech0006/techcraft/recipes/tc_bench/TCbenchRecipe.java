...
public class TCbenchRecipe implements ITCbenchRecipe {
    ...
    public static class TCbenchRecipeSerializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<TCbenchRecipe> {
		...
		public TCbenchRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            String[] astring = TCbenchRecipe.shrink(TCbenchRecipe.patternFromJson(JSONUtils.getAsJsonArray(json, "pattern")));
            int i = astring[0].length();
            int j = astring.length;
            NonNullList<Ingredient> nonnulllist = TCbenchRecipe.deserializeIngredients(astring, map, i, j);
            ItemStack itemstack = TCbenchRecipe.deserializeItem(JSONUtils.getAsJsonObject(json, "result"));
            return new TCbenchRecipe(recipeId, s, i, j, nonnulllist, itemstack);
		}

		@Override
		public TCbenchRecipe fromNetwork(ResourceLocation recipeId, PacketBuffer buffer) {
		...
		@Override
		public void toNetwork(PacketBuffer buffer, TCbenchRecipe recipe) {
