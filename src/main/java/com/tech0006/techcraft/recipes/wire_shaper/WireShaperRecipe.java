...
public class WireShaperRecipe implements IWireShaperRecipe {
    ...
    public static class WireShaperRecipeSerializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<WireShaperRecipe> {
        ...
        public WireShaperRecipe read(ResourceLocation recipeId, JsonObject json) {
            String s = JSONUtils.getString(json, "group", "");
            Ingredient input = WireShaperRecipe.deserializeIn(JSONUtils.getJsonObject(json, "input"));
            ItemStack itemstack = WireShaperRecipe.deserializeItem(JSONUtils.getJsonObject(json, "result"));
            return new WireShaperRecipe(input, itemstack, recipeId, s);
        }

        public WireShaperRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        public void write(PacketBuffer buffer, WireShaperRecipe recipe) {
