...
import com.tech0006.techcraft.GUI.Container.SolarPanel.SolarPanelContainer;
...
public class SolarPanelScreen extends ContainerScreen<SolarPanelContainer> {
    ...
    private static final ResourceLocation TEXTURES = new ResourceLocation(techcraft.MOD_ID, "textures/gui/solar_panel.png");
