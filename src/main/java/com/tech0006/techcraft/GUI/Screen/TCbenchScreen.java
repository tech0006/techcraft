...
public class TCbenchScreen extends ContainerScreen<TCbenchContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(techcraft.MOD_ID,
            "textures/gui/tc_bench.png");

    public TCbenchScreen(TCbenchContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.font.drawString(this.playerInventory.getDisplayName().getFormattedText(), 8.0f, 125.0f, 0x404040);
    }
