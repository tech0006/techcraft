...
public class BronzeSafeScreen extends ContainerScreen<BronzeSafeContainer> {
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(techcraft.MOD_ID, "textures/gui/bronze_safe.png");

    public BronzeSafeScreen(BronzeSafeContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
