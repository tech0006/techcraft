...
public class SafeScreen extends ContainerScreen<SafeContainer> {
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(techcraft.MOD_ID, "textures/gui/safe.png");

    public SafeScreen(SafeContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
