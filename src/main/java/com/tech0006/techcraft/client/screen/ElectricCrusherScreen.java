...
public class ElectricCrusherScreen extends AbstractContainerScreen<ElectricCrusherContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(techcraft.MOD_ID, "textures/gui/electric_crusher.png");
    private final ElectricCrusherBlockEntity tile;

    public ElectricCrusherScreen(ElectricCrusherContainer container, Inventory inv, Component name) {
