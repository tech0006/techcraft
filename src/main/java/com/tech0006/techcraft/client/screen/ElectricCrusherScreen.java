...
public class ElectricCrusherScreen extends ContainerScreen<ElectricCrusherContainer> {
    ...
    private static final ResourceLocation TEXTURES = new ResourceLocation(techcraft.MOD_ID, "textures/gui/electric_crusher.png");
    private final ElectricCrusherTileEntity tile;

    public ElectricCrusherScreen(ElectricCrusherContainer container, PlayerInventory inv, ITextComponent name) {
