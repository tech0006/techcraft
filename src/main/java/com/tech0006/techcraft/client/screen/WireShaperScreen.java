...
public class WireShaperScreen extends AbstractContainerScreen<WireShaperContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(techcraft.MOD_ID,
            "textures/gui/wire_shaper.png");

    public WireShaperScreen(WireShaperContainer screenContainer, Inventory inv, Component titleIn) {
