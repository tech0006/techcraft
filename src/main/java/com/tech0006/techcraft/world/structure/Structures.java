...
public class Structures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> SCIENTIST_HOUSE = STRUCTURES.register("scientist_house", ScientistHouseStructure::new);

    public static void setupStructures() {
        setupMapSpacingAndLand(SCIENTIST_HOUSE.get(), new StructureSeparationSettings(200,100, 1234567890),true);
    }
