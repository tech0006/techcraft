...
public class AlloyPlantRecipeCategory implements IRecipeCategory<AlloyPlantRecipe> {
    ...
    public AlloyPlantRecipeCategory(IGuiHelper guiHelper) {
        this.localizedName = new TextComponent(I18n.get("block.techcraft.alloy_plant"));
    ...
    @Override
    public void draw(AlloyPlantRecipe recipe, PoseStack matrixStack, double mouseX, double mouseY) {
